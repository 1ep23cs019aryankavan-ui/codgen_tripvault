  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 text-sm text-gray-500">
            ...
            {user?.username && (
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-white/60 px-3 py-1 font-medium text-primary-700 transition hover:bg-white"
              >
                <UserIcon /> @{user.username}
                <span className="text-xs text-gray-400">View public profile →</span>
              </Link>
            )}
          </div>
        </div>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-12 sm:px-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Add destinations, dates & ratings</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-gray-900">My public profile</h3>
              <p className="text-sm text-gray-500">Share your travel page with the world</p>
            </div>
          </Link>
        ...
        {/* Edit profile strip */}
        <div className="mt-4 flex flex-col items-start justify-between gap-3 rounded-xl border border-gray-200 bg-gradient-to-r from-primary-50 to-accent-50 p-5 sm:flex-row sm:items-center">
          <div>
            <h3 className="font-semibold text-gray-900">Personalize your profile</h3>
            <p className="text-sm text-gray-600">
              Add a bio and manage your public username so other travelers can discover you.
            </p>
          </div>
          <Link
            to="/edit-profile"
            className="shrink-0 rounded-lg bg-primary-600 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-primary-600/30 transition hover:bg-primary-700"
          >
            Edit profile
          </Link>
        </div>
...
function UserCircleIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" />
      <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" transform="translate(-2 -4) scale(0.95)" />
