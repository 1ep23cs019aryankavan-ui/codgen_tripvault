...
router.post('/', async (req, res) => {
  const { title, destination, startDate, endDate, story, isPublic } = req.body;
...
/**
 * PUT /api/trips/:id
 * Update a trip (title, destination, dates, story, isPublic).
 */
router.put('/:id', async (req, res) => {
  try {
    ...
    if (story !== undefined) trip.story = story;
