...
| **Photo Uploads** | Drag-and-drop **or** file picker (works on PC + phone camera/gallery); ≤5MB each, ≤10 per trip |
...
| File Uploads | **Multer** (memory storage, serverless-friendly) — images stored as Buffers in MongoDB |
| Security | dotenv, CORS, ownership-scoped routes |
